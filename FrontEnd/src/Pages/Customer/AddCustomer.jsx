      ...
      <div className={`transition-all duration-300 ${collapsed ? "md:ml-16" : "md:ml-60"}`}>
        ...
        <main className="max-w-4xl p-6 mx-auto">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-semibold text-[#0B1F3A]">Add New Customer</h1>
              <p className="text-sm text-slate-500 mt-0.5">Fill in the details below to create a customer profile.</p>
            </div>
          </div>
            ...
            <div className="p-6 bg-white border rounded-2xl border-slate-200">
              <div className="flex flex-col items-start gap-6 sm:flex-row">
                ...
                <div className="flex flex-col items-center gap-2 mx-auto shrink-0 sm:mx-0">
                  ...
                  >
                    {imagePreview ? (
                      <img src={imagePreview} alt="Customer" className="object-cover w-full h-full" />
                    ) : (
        ...
        >
          ...
          >
            ...
            <div className="p-7">
              ...
              <h3 className="text-lg font-semibold text-[#0B1F3A]">Customer limit reached</h3>
              ...
              {limitInfo.limit != null && (
                <div className="flex items-center justify-between px-4 py-3 mt-4 text-sm rounded-lg bg-slate-50">
                  ...
                  <span className="font-semibold text-[#0B1F3A]">
                    {limitInfo.current} / {limitInfo.limit} customers
                  </span>
                </div>
              )}
